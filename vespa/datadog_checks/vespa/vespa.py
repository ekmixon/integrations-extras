...
class VespaCheck(AgentCheck):
    ...
    def check(self, instance):
        ...
        try:
            ...
            self.service_check(
                ...
                AgentCheck.OK,
                tags=instance_tags,
                message=f"Metrics collected successfully for consumer {consumer}",
            )
    ...
    def _report_metrics_error(self, msg, level, instance_tags):
        ...
        self.log.warning(
            (
                f"Issued a warning to {self.PROCESS_SERVICE_CHECK}"
    ...
    def _report_service_status(self, instance_tags, service_name, service):
        ...
        if code == "up":
            self.service_check(
                ...
                AgentCheck.OK,
                tags=tags,
                message=f"Service {service_name} returns up",
            )
