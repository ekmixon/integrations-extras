...
class PhpOpcacheCheck(AgentCheck):
    def check(self, instance):
        ...
        try:
            ...
            self.service_check('php_opcache.can_connect', self.CRITICAL, tags=service_check_tags, message=str(e))
        else:
            self.service_check('php_opcache.can_connect', self.OK, tags=service_check_tags)
